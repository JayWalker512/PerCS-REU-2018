...
#Returns a list of column names as extracted from the first row of the provided CSV file.
#filename: path to CSV file to load
#delimiter: in this case a comma, not actually used in code below
...
#Scale features for inputting to a classifier. Uses default scaling provided by sklearn.
#listOfRows: a list of lists, each list being a training example/set of features
...
#Set up Logistic Regression classifier and train it using the foldTrainTest function.
#X: training examples
#Y: labels
#nFolds: number of folds to use for cross validation
...
#Set up Decision Tree classifier and train it using the foldTrainTest function.
#X: training examples
#Y: labels
#nFolds: number of folds to use for cross validation
...
#Set up Shallow Decision Tree classifier and train it using the foldTrainTest function.
#X: training examples
#Y: labels
#nFolds: number of folds to use for cross validation
