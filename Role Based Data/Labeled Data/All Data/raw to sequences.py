...
#make an NN with 3 hidden layers where number of neurons is equal to number of features.
#clf = MLPClassifier(activation='relu', hidden_layer_sizes=(len(X[0]), len(X[0]), len(X[0])) )
#clf = MLPClassifier(activation='logistic', hidden_layer_sizes=(len(X[0]), len(X[0]), len(X[0])) )

#widen the layers to gather more nonlinearities
#clf = MLPClassifier(activation='relu', hidden_layer_sizes=(len(X[0])*2, len(X[0])*2, len(X[0])*2) )

input_width = len(X[0])
clf = MLPClassifier(activation='relu', hidden_layer_sizes=(input_width*2, input_width*2, input_width*2, input_width*2, input_width*2) )
